...
const translations = {
  en: {
    ...
    'tools.category.design-development': 'Design & Development Tools',
            ...
            'brand.hero.tag': 'Identity System 2.0',
            'brand.hero.title': 'Adaptive. Clear. Impactful.',
            'brand.hero.description': 'Just like our products, our brand morphs to fit the context. It beautifully blends to create clarity and deliver a strong impact.',
            ...
            'brand.colors.blue': 'UI Accent Blue',
            'brand.colors.blueDesc': 'Reserved for UI affordances only: focus rings, links, active states, loading indicators. Keep usage under 5% of any composition. Do not use for logos, marketing, or hero visuals.',
            'brand.colors.copied': 'Copied!',
            'brand.typography.primaryTitle': 'Primary Typeface: Pretendard (Inter)',
            'brand.typography.primaryDesc': 'We use Pretendard (or Inter) as our main typeface for its cleanliness, readability, and modern aesthetic. It works well in both headings and body text.',
            ...
            'brand.typography.heroTitle': 'Hero Typeface: Nunito',
            'brand.typography.heroDesc': 'Used for navigation, hero headlines, and high-impact display text. Rounded and approachable, it adds warmth to key touchpoints.',
            'brand.typography.heroMeta': 'Header / Extrabold / 36px',
            'brand.typography.secondaryTitle': 'Secondary Typeface: Anonymous Pro',
            'brand.typography.secondaryDesc': 'We use a mono face like Anonymous Pro to emphasize our tech roots and that we are a product-first company. Use it for kickers, labels, code snippets, or technical data.',
  ...
  ko: {
    ...
    'tools.category.design-development': '디자인 & 개발 도구',
            ...
            // Brand guidelines (Identity System 2.0)
            'brand.hero.tag': '아이덴티티 시스템 2.0',
            'brand.hero.title': '적응성. 명확성. 임팩트.',
            'brand.hero.description': '우리의 제품처럼, 브랜드 또한 맥락에 맞춰 변화합니다. 명확성을 잃지 않으면서도 강력한 임팩트를 전달합니다.',
            ...
            'brand.colors.blue': 'UI 강조색 블루',
            'brand.colors.blueDesc': 'UI 전용: 포커스 링, 링크, 활성 상태, 로딩 표시에만 사용합니다. 화면당 5% 미만으로 제한하세요. 로고, 마케팅, 히어로 비주얼에는 사용하지 마세요.',
            'brand.colors.copied': '복사됨!',
            'brand.typography.primaryTitle': '주요 서체: Pretendard (Inter)',
            'brand.typography.primaryDesc': '깔끔함, 가독성, 현대적인 미학을 위해 Pretendard(또는 Inter)를 주요 서체로 사용합니다. 제목과 본문 모두에 적합합니다.',
            'brand.typography.h1Meta': 'Heading 1 / Bold / 48px',
            ...
            'brand.typography.heroTitle': '히어로 서체: Nunito',
            'brand.typography.heroDesc': '네비게이션, 히어로 헤드라인, 임팩트 있는 디스플레이 텍스트에 사용합니다. 둥글고 친근한 인상을 줍니다.',
            'brand.typography.heroMeta': '헤더 / Extrabold / 36px',
            'brand.typography.secondaryTitle': '보조 서체: Anonymous Pro',
            'brand.typography.secondaryDesc': '기술적 뿌리와 제품 중심 회사임을 강조하기 위해 Anonymous Pro와 같은 고정폭 서체를 사용합니다. 키커, 라벨, 코드 조각 또는 기술 데이터에 사용하세요.',
            'brand.typography.kickerMeta': 'Kicker / Bold / 14px',
