...
const translations = {
  en: {
    ...
    'tools.category.design-development': 'Design & Development Tools',
            ...
            'brand.imagery.description': 'We prefer dynamic visuals that move and interact over static imagery. When images are needed, we follow strict principles to maintain authenticity and brand coherence.',
            ...
            'brand.imagery.motionDesc': 'Whenever possible, replace static imagery with animation and interaction. Our brand comes alive through movement — not frozen frames.',
  ...
  ko: {
    ...
    'tools.category.design-development': '디자인 & 개발 도구',
            ...
            'brand.imagery.description': '우리는 정적인 이미지보다 움직이고 상호작용하는 동적 비주얼을 선호합니다. 이미지가 필요한 경우, 진정성과 브랜드 일관성을 유지하기 위해 엄격한 원칙을 따릅니다.',
            ...
            'brand.imagery.motionDesc': '가능하면 정적 이미지를 애니메이션과 인터랙션으로 대체합니다. 우리 브랜드는 멈춘 프레임이 아닌 움직임을 통해 살아납니다.',
