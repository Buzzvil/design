...
const translations = {
  en: {
    ...
    'tools.category.design-development': 'Design & Development Tools',
            ...
            'product.guidelines.interaction.title': 'Interaction',
            'product.guidelines.interaction.subtitle': 'The foundation of our product experience',
            'product.guidelines.interaction.description': 'We define interaction patterns before any visual design work begins. These patterns establish how users navigate, engage, and accomplish tasks within our products.',
            'product.guidelines.interaction.principle1': 'Define clear user flows and navigation patterns before visual design',
            'product.guidelines.interaction.principle2': 'Ensure consistent interaction behaviors across all touchpoints',
            'product.guidelines.interaction.principle3': 'Design for accessibility and inclusive user experiences',
            'product.guidelines.interaction.principle4': 'Test and validate interaction patterns with real users',
            ...
            'product.guidelines.microInteractions.title': 'Micro-interactions & Animations',
            'product.guidelines.microInteractions.subtitle': 'Polishing details that bring experiences to life',
            'product.guidelines.microInteractions.description': 'These subtle details add personality and feedback to our interactions, making the experience feel responsive and delightful.',
            'product.guidelines.microInteractions.principle1': 'Use animations to provide clear feedback for user actions',
            'product.guidelines.microInteractions.principle2': 'Keep micro-interactions purposeful and not distracting',
            'product.guidelines.microInteractions.principle3': 'Ensure animations enhance accessibility, not hinder it',
            'product.guidelines.microInteractions.principle4': 'Test performance impact of animations on various devices',
  ...
  ko: {
    ...
    'tools.category.design-development': '디자인 & 개발 도구',
            ...
            'product.guidelines.interaction.title': '상호작용',
            'product.guidelines.interaction.subtitle': '제품 경험의 기초',
            'product.guidelines.interaction.description': '시각적 디자인 작업을 시작하기 전에 상호작용 패턴을 정의합니다. 이러한 패턴은 사용자가 제품 내에서 탐색하고 참여하며 작업을 완료하는 방법을 설정합니다.',
            'product.guidelines.interaction.principle1': '시각적 디자인 전에 명확한 사용자 플로우와 탐색 패턴 정의',
            'product.guidelines.interaction.principle2': '모든 터치포인트에서 일관된 상호작용 행동 보장',
            'product.guidelines.interaction.principle3': '접근성과 포용적인 사용자 경험을 위한 디자인',
            'product.guidelines.interaction.principle4': '실제 사용자와 상호작용 패턴 테스트 및 검증',
            ...
            'product.guidelines.microInteractions.title': '마이크로 상호작용 & 애니메이션',
            'product.guidelines.microInteractions.subtitle': '경험을 생생하게 만드는 세부 사항',
            'product.guidelines.microInteractions.description': '이러한 미묘한 세부 사항은 우리의 상호작용에 개성과 피드백을 추가하여 경험이 반응적이고 즐겁게 느껴지도록 합니다.',
            'product.guidelines.microInteractions.principle1': '사용자 행동에 대한 명확한 피드백을 제공하기 위해 애니메이션 사용',
            'product.guidelines.microInteractions.principle2': '마이크로 상호작용을 목적 있게 유지하고 방해가 되지 않도록 함',
            'product.guidelines.microInteractions.principle3': '애니메이션이 접근성을 방해하지 않고 향상시키도록 보장',
            'product.guidelines.microInteractions.principle4': '다양한 기기에서 애니메이션의 성능 영향 테스트',
