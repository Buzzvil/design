...
const Footer = () => {
  ...
  const footerLinks: Record<string, FooterLink[]> = {
    ...
    'Product': [
      { name: t('product.sections.principles'), href: '/design/product/#principles' },
      { name: t('product.sections.layers'), href: '/design/product/#layers' },
      { name: t('product.sections.chameleon'), href: '/design/product/#chameleon' },
      { name: t('product.sections.patterns'), href: '/design/product/#patterns' },
      { name: t('product.sections.conventions'), href: '/design/product/#conventions' },
    ],
    'Connect': [
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 bg-muted rounded-lg flex items-center justify-center hover:bg-white/15 transition-colors group"
                >
